...
// Warm Beige (#FAF5F0) Basis, Bordeaux + Gold
// Warm & elegant, aber nicht zu dunkel
...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        bg: {
          primary: "#FAF5F0",   // Warm Beige
          deep: "#F0E8DC",      // Dunkleres Beige
          elevated: "#FFF8F2",  // Noch heller
        },
        accent: {
          gold: "#D4A574",      // Gold
        ...
        text: {
          cream: "#2D0A0F",     // Bordeaux für Text
